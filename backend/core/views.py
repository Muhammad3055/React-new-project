...
def api_send_otp(request):
    ...
    subject = f"Your Maktaba tul Muslim Verification Code: {otp_code}"

    # Plain text fallback
    message = (
        f"Assalamu Alaikum,\n\n"
        f"Your verification code for Maktaba tul Muslim is:\n\n"
        f"  {otp_code}\n\n"
        f"This code expires in 5 minutes.\n"
        f"If you did not request this, please ignore this email.\n\n"
        f"BarakAllahu Feek,\n"
        f"Maktaba tul Muslim\n"
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f5;padding:40px 20px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);max-width:560px;width:100%;">
        <!-- Header -->
        <tr>
          <td style="background:linear-gradient(135deg,#1a4731 0%,#2d7a4f 100%);padding:32px 40px;text-align:center;">
            <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:800;letter-spacing:-0.5px;">
              🕌 Maktaba tul Muslim
            </h1>
            <p style="margin:6px 0 0;color:rgba(255,255,255,0.75);font-size:13px;">maktabatulmuslim.com</p>
          </td>
        </tr>
        <!-- Body -->
        <tr>
          <td style="padding:40px 40px 32px;">
            <p style="margin:0 0 8px;color:#374151;font-size:15px;font-weight:600;">Assalamu Alaikum,</p>
            <p style="margin:0 0 28px;color:#6b7280;font-size:14px;line-height:1.6;">
              Use the verification code below to complete your action on Maktaba tul Muslim.
              This code is valid for <strong>5 minutes</strong>.
            </p>
            <!-- OTP Box -->
            <div style="background:#f0fdf4;border:2px solid #d4af37;border-radius:12px;padding:28px;text-align:center;margin-bottom:28px;">
              <p style="margin:0 0 8px;color:#374151;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px;">Verification Code</p>
              <p style="margin:0;color:#1a4731;font-size:42px;font-weight:900;letter-spacing:12px;font-family:'Courier New',monospace;">{otp_code}</p>
            </div>
        ...
        <tr>
          <td style="background:#f9fafb;border-top:1px solid #e5e7eb;padding:20px 40px;text-align:center;">
            <p style="margin:0;color:#9ca3af;font-size:12px;">
              © 2026 Maktaba tul Muslim &nbsp;|&nbsp;
              <a href="https://maktabatulmuslim.com" style="color:#2d7a4f;text-decoration:none;">maktabatulmuslim.com</a>
            </p>
