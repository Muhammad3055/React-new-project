...
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='maktabatulmuslim@gmail.com')
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', default='')
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='Maktaba tul Muslim <maktabatulmuslim@gmail.com>')
